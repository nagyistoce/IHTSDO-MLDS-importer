...
public class PropertiesLoader {
	...
	public PropertiesLoader(final List<String> keyValuesIn) {
		super();
		keyValues = keyValuesIn;
	}

	public PropertiesLoader(final List<String> keyValuesIn,
			final String fileKeyIn) {
		super();
		keyValues = keyValuesIn;
		fileKey = fileKeyIn;
	}
	...
	public PropertiesLoader(final List<String> keyValuesIn,
			final String fileKeyIn, final Properties initPropsIn) {
		super();
		keyValues = keyValuesIn;
		fileKey = fileKeyIn;
	...
	public PropertiesLoader(final String[] argsIn,
			final List<String> keyValuesIn) {
		super();
		args = argsIn;
		keyValues = keyValuesIn;
	}
	...
	public PropertiesLoader(final String[] argsIn,
			final List<String> keyValuesIn, final String fileKeyIn) {
		super();
		args = argsIn;
		keyValues = keyValuesIn;
		fileKey = fileKeyIn;
	...
	public final void setKeyValues(final List<String> keyValuesIn) {
		keyValues = keyValuesIn;
	}
	...
	public final void setArgs(final String[] argsIn) {
		args = argsIn;
	}

	public final void addKeyValToProps(final String key, final String val,
	...
	private void addEnvVars(final Properties setProps) {
	...
	private void addSysProps(final Properties setProps) {
	...
	private void addArgs(final Properties setProps) {
		if (args != null) {
			for (String arg : args) {
	...
	private Properties addPropsFromFile(final Properties setProps) {
	...
	public final void setFileKey(final String fileKeyIn) {
		fileKey = fileKeyIn;
	}
	...
	public final void setInitProps(final Properties initPropsIn) {
		initProps = initPropsIn;
	}
	...
	public final void setSysVarArgProps(final Properties sysVarArgPropsIn) {
		sysVarArgProps = sysVarArgPropsIn;
	}

	public static final void logProps(final Properties props) {
